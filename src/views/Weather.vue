...
const apikey = "b98ea782fc00cade55134b82973a1e43"
...
export default {
  ...
  }, // <-- Closing brace for the methods block is missing
}; // <-- Closing brace for the export default block

</script> <!-- Missing closing script tag -->
